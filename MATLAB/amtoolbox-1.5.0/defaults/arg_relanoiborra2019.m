...
%
%   Url: http://amtoolbox.org/amt-1.5.0/doc/defaults/arg_relanoiborra2019.php
...
definput.flags.prepanning = {'prepanning','no_prepanning','prepanning_external'};
definput.keyvals.N_org = [];
definput.keyvals.N_prepanning = [];
